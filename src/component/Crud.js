...
const Crud = () => {
  ...
  return (
    <div className='p-2'>
      ...
      <form onSubmit={formik.handleSubmit} className='max-w-3xl  p-10 space-y-4 shadow-2xl  ' >
        ...
        <div className='space-y-2'>
          ...
          {isVal(formik, 1) ? <h1>{formik.errors.email}</h1> : null}
        </div>
        ...
        <div className='space-y-2'>
          ...
          <input type="username"
            ...
            className='outline-none border border-brown-400 px-2 py-1 rounded-md'
          />
          {isVal(formik, 2) ? <h1>{formik.errors.username}</h1> : null}
        </div>
